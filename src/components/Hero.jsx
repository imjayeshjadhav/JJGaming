...
const Hero = () => {
    ...
    const [isLoading , setIsLoading] = useState(true) // not working if initialized as true
        ...
        <div className="relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75" id='video-frame'>
            ...
            <div>
                <video
                    ...
                    muted
                    id='next-video'
                    className='absolute-center invisible absolute z-20 sie-64 object-cover object-center'
                    onLoadedData={handleVideoLoad}
                />
                <video
